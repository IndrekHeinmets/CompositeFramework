...
############################# USER INPUT ###################################
sin_x = 0.5  # Sin Function X
step = 0.1  # Yarn Path Spline Step

spec_size_x = 6
spec_size_z = 6

base_array = np.zeros((spec_size_x + 2, spec_size_z + 2))
...
# def find_spline_nodes(sin_x, step, pi_len):
#     points = []
...
# def find_spline_nodes_l(sin_x, step, pi_len, overlap_len):
#     points = []
#     offset = 0

#     for i in range(int((pi_len * pi) / step)):
#         x = step * i
#         y_b = sin(sin_x * (x - step))
#         y = sin(sin_x * x)
#         y_a = sin(sin_x * (x + step))
#         x += offset
...
# # Sin spline nodes:
# points = find_spline_nodes(sin_x, step, pi_len)
# points_l = find_spline_nodes_l(sin_x, step, (pi_len / 2), overlap_len)
...
# s1.EllipseByCenterPerimeter(center=(0.0, 0.0), axisPoint1=(0.0, (e_width / 2)), axisPoint2=((e_height / 2), 0.0))
...
# s3.EllipseByCenterPerimeter(center=(0.0, 0.0), axisPoint1=(0.0, (e_width / 2)), axisPoint2=((e_height / 2), 0.0))
...
# p1.BaseSolidExtrude(sketch=s4, depth=b_width)
...
# a.translate(instanceList=('ResinBlock-1', ), vector=(0.0, -(b_height / 2), 0.0))
...
# s.rectangle(point1=((19.0, (19.0), point2=(-(19.0 / sc), -(19.0 / sc)))
