...
a = mdb.models['Model-1'].rootAssembly
region = a.sets['RPSet']
mdb.models['Model-1'].DisplacementBC(name='Load', createStepName='StaticAnalysis', region=region, u1=l_disp, u2=UNSET, u3=UNSET, ur1=UNSET, ur2=UNSET, ur3=UNSET, amplitude=UNSET, fixed=OFF, distributionType=UNIFORM, fieldName='', localCsys=None)
...
mdb.models['XTensCase'].rootAssembly.regenerate()
mdb.models['XCompCase'].boundaryConditions['Load'].setValues(u1=-l_disp)
mdb.models['XCompCase'].rootAssembly.regenerate()
...
mdb.models['YShearCase'].Equation(name='ConstraintEqn', terms=((1.0, 'Composite-1.XFront', 2), (-1.0, 'RPSet', 2)))
