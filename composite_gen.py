...
# Elipse cs:
e_width, e_height = 4.5, 0.6

# Resin block:
overhang = 0.5
b_width, b_height = ((pi_len * pi) - (2 * overhang)), 4.0
...
# Sin wave 1:
s = mdb.models['Model-1'].ConstrainedSketch(name='__sweep1__', sheetSize=100.0)
...
# Wave profile 1:
s1 = mdb.models['Model-1'].ConstrainedSketch(name='__profile1__', sheetSize=100.0, transform=(0.499980071344579, -0.866036909293288, 0.0, -0.0, 0.0, 1.0, -0.866036909293288, -0.499980071344579, -0.0, 0.0, 0.0, 0.0))
g1, v1, d1, c1 = s1.geometry, s1.vertices, s1.dimensions, s1.constraints
s1.setPrimaryObject(option=SUPERIMPOSE)
s1.ConstructionLine(point1=(-50.0, 0.0), point2=(50.0, 0.0))
...
# Sin wave 2:
s2 = mdb.models['Model-1'].ConstrainedSketch(name='__sweep2__', sheetSize=100.0)
...
# Wave profile 2:
s3 = mdb.models['Model-1'].ConstrainedSketch(name='__profile2__', sheetSize=100.0, transform=(0.499980071344579, -0.866036909293288, 0.0, -0.0, 0.0, 1.0, -0.866036909293288, -0.499980071344579, -0.0, 0.0, 0.0, 0.0))
g3, v3, d3, c3 = s3.geometry, s3.vertices, s3.dimensions, s3.constraints
s3.setPrimaryObject(option=SUPERIMPOSE)
s3.ConstructionLine(point1=(-50.0, 0.0), point2=(50.0, 0.0))
s3.ConstructionLine(point1=(0.0, -50.0), point2=(0.0, 50.0))
...
# Resin block profile:
s4 = mdb.models['Model-1'].ConstrainedSketch(name='__profile3__', sheetSize=100.0)
